...
class HyperionClient:
    ...
    def __init__(self, log_callback: Callable, message_callback: Callable, data_dir: str = "."):
    ...
    def panic(self):
        self.log_callback("[!] PANIC - Wiping all data")
        self.running = False
        if self.active_session:
        ...
        self.transport.close()
        self.log_callback("[+] All keys and data wiped")
        return True
